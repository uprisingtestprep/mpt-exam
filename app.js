/* MPT Exam Simulator — Application Logic */

const ACCESS_CODE  = "MPT9000";
const EXAM_SECONDS = 10800;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "mpt_exam_state_v1";
const SIM_Q_COUNT  = 100;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"number_sense_and_numeration": "Number Sense and Numeration", "algebra_and_patterning": "Algebra and Patterning", "data_literacy_and_probability": "Data Literacy and Probability", "geometry_and_spatial_sense": "Geometry and Spatial Sense", "measurement": "Measurement", "financial_literacy": "Financial Literacy", "mathematics_curriculum_and_instructional_foundations": "Mathematics Curriculum and Instructional Foundations", "assessment_and_evaluation_practices": "Assessment and Evaluation Practices", "learning_for_all_and_inclusive_teaching": "Learning for All and Inclusive Teaching"};  // maps domain key -> human-readable label for display
